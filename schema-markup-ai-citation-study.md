...
I'm leaving the FAQ schema already on both my sites in place — it isn't
hurting anything, and it still does what it was originally built for with
other rich results and voice assistants. I'm not adding more of it as an
AI-citation play, and I'm not counting the checklist item as done just
because the markup exists. Whatever is actually driving citation looks like
content quality and third-party trust signals underneath the markup, not the
markup itself — slower to work on, and a much less satisfying box to check.
